...
export default function ScenarioDuress() {
  const navigate = useNavigate();
  const { saveElapsedTime } = usePageTimer();
  useBlockBrowserBack();

  const fullText =
    "You are coming home. There's someone forcing you to open the door and disarm the alarm.";
  ...
  function handleNext() {
    ...
    saveElapsedTime("scenarioDuressTime");
